...
export function getDifficultyColor(level: string): string {
  switch (level) {
    ...
    case 'EASY': return 'bg-teal-100 text-teal-700 dark:bg-teal-900 dark:text-teal-300';
    case 'MEDIUM': return 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300';
    case 'HARD': return 'bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-300';
