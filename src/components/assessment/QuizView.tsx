      ...
      <CardContent className="space-y-4">
        ...
        {result && (
          <div className={cn(
            ...
            {result.misconceptionTriggered && result.misconceptionText && (
              <div className="mt-2 p-3 rounded-md bg-amber-50 dark:bg-amber-950/40 border border-amber-300 dark:border-amber-700">
                <p className="text-xs font-semibold text-amber-700 dark:text-amber-400 mb-1 flex items-center gap-1">
                  <AlertTriangle className="h-3.5 w-3.5" /> Common Misconception Detected
                </p>
                <p className="text-sm text-amber-900 dark:text-amber-200">{result.misconceptionText}</p>
              </div>
            )}
            {result.explanation && (
